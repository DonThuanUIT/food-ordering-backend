...
### Cơ sở dữ liệu:
*   `[NEW]` [V7__add_shop_settings_and_vouchers.sql](file:///d:/food-ordering-backend/backend/src/main/resources/db/migration/V7__add_shop_settings_and_vouchers.sql): Script tự động tạo bảng cài đặt, bảng voucher và liên kết khóa ngoại.
